                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="text-center">Active Location </h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody class="table text-center">
                                            ...
                                            @foreach ($trashedRequirement as $requirement)
                                                <tr>
                                                    ...
                                                    <td class="td_btn">
                                                        <a href="{{ route('backend.location.reStore', $requirement->id) }}"
                                                            class="btn btn-sm btn-success">Restore</a>

                                                        <form
                                                            action="{{ route('backend.location.delete', $requirement->id) }}"
            ...
            <div class="col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="card m_top">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('backend.location.store') }}" method="POST"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('backend.location.update', $requirement->id) }}" method="POST"
                    enctype="multipart/form-data">
