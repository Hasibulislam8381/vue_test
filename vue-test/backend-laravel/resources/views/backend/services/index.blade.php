                                        ...
                                        <tbody class="table">
                                            ...
                                            @foreach ($activedreamWithUs as $dreamWithUs)
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{ $dreamWithUs->title ?? ($dreamWithUs->title_head ?? 'NULL') }}
                                                    </td>
                                                    <td>{!! \Illuminate\Support\Str::limit($dreamWithUs->description, 50) ??
                                                        \Illuminate\Support\Str::limit($dreamWithUs->description_head, 50) !!}</td>
                                                     ...
                                                     <td class="td_btn text-center">
                                                        <a href="{{ $dreamWithUs->type === 'heading' ? route('backend.services.editHead', $dreamWithUs->id) : route('backend.services.edit', $dreamWithUs->id) }}"
                                                    ...
                                                    <td class="td_btn text-center">
                                                        ...
                                                        <a href="{{ route('backend.services.status', $dreamWithUs->id) }}"
                                                        ...
                                                        <a href="{{ route('backend.services.trash', $dreamWithUs->id) }}"
                                        ...
                                        <tbody class="table">
                                            ...
                                            @foreach ($trasheddreamWithUs as $dreamWithUs)
                                                <tr>
                                                    ...
                                                    <td class="td_btn">
                                                        <a href="{{ route('backend.services.reStore', $dreamWithUs->id) }}"
                                                            class="btn btn-sm btn-success">
                                                            <i class="fas fa-undo"></i> Restore
                                                        </a>

                                                        <form
                                                            action="{{ route('backend.services.delete', $dreamWithUs->id) }}"
