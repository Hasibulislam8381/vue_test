                        ...
                        <div class="card-body">
                            <form action="{{ route('backend.meta.update', $meta->id) }}" method="POST"
                                ...
                                <div class="form-group mt-2">
                                    <b>Bradcamp Photo:(1200*500)</b>
                                    <input type="file" name="bradcamp" class="form-control">
                                    <img src="{{ $meta->bradcamp }}" class="mt-2" width="60" alt="bradcamp">
                                </div>
                                <div class="form-group mt-2">
                                    <b>Page Name:</b>
                                ...
                                <div class="form-group mt-2">
                                    <b>Keyword:</b>
                                    <input type="text" name="keyword" class="form-control" value="{{ $meta->keyword }}">
                                </div>
                                <div class="form-group mt-2">
                                    <b>Description:</b>
                                ...
                                <div class="form-group mt-2">
                                    <b>Meta Photo:</b>
                                    <input type="file" name="meta_photo" class="form-control">
                                    <img src="{{ $meta->meta_photo }}" class="mt-2" width="60" alt="meta">
                                </div>
