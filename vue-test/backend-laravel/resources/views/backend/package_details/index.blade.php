                                                ...
                                                <tr>
                                                    ...
                                                    @if ($dreamWithUs->id == 1)
                                                        <td class="td_btn text-center">
                                                            <a href="{{ route('backend.package_details.edit', $dreamWithUs->id) }}"
                                                    ...
                                                    @else
                                                        <td class="td_btn text-center">
                                                            ...
                                                            <a href="{{ route('backend.package_details.status', $dreamWithUs->id) }}"
                                                            ...
                                                            <a href="{{ route('backend.package_details.trash', $dreamWithUs->id) }}"
                                        ...
                                        <tbody class="table">
                                            ...
                                            @foreach ($trasheddreamWithUs as $dreamWithUs)
                                                <tr>
                                                    ...
                                                    <td class="td_btn">
                                                        <a href="{{ route('backend.package_details.reStore', $dreamWithUs->id) }}"
                                                            class="btn btn-sm btn-success">
                                                            <i class="fas fa-undo"></i> Restore
                                                        </a>

                                                        <form
                                                            action="{{ route('backend.package_details.delete', $dreamWithUs->id) }}"
